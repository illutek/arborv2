...
function config($key = '')
{
    $config = [
        ...
        'tree_menu' => [
            ...
            'verplanten-van-bomen' => 'Verplanten van bomen',
            'versnipperen-en-afvoeren-van-takken-en-loof' => 'Versnipperen en afvoeren van takken en loof',
            'ziekte-en-plaagbestrijding' => 'Ziekte- en plaagbestrijding',
        ],
